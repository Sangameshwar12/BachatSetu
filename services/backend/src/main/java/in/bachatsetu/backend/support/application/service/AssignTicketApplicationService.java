...
public final class AssignTicketApplicationService implements AssignTicketUseCase {
    ...
    @Override
    public SupportTicketResult execute(AssignTicketCommand command) {
        ...
        return transaction.execute(() -> {
            ...
            ticket.assign(command.assigneeId(), command.actorId(), clock.now());
