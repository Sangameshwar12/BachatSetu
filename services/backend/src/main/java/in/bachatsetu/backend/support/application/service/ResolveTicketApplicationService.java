...
public final class ResolveTicketApplicationService implements ResolveTicketUseCase {
    ...
    @Override
    public SupportTicketResult execute(ResolveTicketCommand command) {
        ...
        return transaction.execute(() -> {
            ...
            ticket.resolve(command.resolution(), command.actorId(), clock.now());
