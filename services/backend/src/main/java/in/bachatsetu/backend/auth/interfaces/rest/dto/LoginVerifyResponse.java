...
/** The caller's new access and refresh tokens after a successful login. */
public record LoginVerifyResponse(
        @Schema(description = "Signed-in user identifier", example = "123e4567-e89b-12d3-a456-426614174000")
        String userId,
