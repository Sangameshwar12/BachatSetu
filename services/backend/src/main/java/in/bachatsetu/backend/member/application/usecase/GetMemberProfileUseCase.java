...
/** Retrieves one tenant-scoped member profile, restricted to the member themselves. */
@FunctionalInterface
public interface GetMemberProfileUseCase {

    MemberProfileResult execute(AggregateId tenantId, AggregateId memberId, AggregateId actorId);
}
