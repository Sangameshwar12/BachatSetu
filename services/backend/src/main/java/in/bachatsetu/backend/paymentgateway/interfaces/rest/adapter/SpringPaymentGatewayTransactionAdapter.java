...
/** Executes one Payment Gateway use case inside a Spring-managed transaction. */
public final class SpringPaymentGatewayTransactionAdapter implements TransactionPort {

    private final TransactionTemplate transactionTemplate;

    public SpringPaymentGatewayTransactionAdapter(TransactionTemplate transactionTemplate) {
