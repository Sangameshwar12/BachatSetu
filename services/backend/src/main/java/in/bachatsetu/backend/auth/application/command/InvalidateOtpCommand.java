...
/** Invalidates the current OTP challenge. */
public record InvalidateOtpCommand(UserId userId, OtpPurpose purpose, AggregateId actorId) {

    public InvalidateOtpCommand {
