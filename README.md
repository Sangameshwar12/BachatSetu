...
Every completed REST module registers its endpoints here: OTP Authentication — signup (`/api/v1/auth/signup*`), returning-user login (`/api/v1/auth/login/*`), and session management (`/api/v1/auth/token/refresh`, `/api/v1/auth/logout`) — Savings Groups (`/api/v1/groups/**`), Members (`/api/v1/members/**`), Payments (`/api/v1/payments/**`), Draws (`/api/v1/draws/**`), Receipts (`/api/v1/receipts/**`), Notifications (`/api/v1/notifications/**`), and Auctions (`/api/v1/auctions/**`).
